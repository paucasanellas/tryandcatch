...
3. **El PR de release no pasa el CI y no lo necesita**: cada cambio ya pasó los checks en su propia PR, y el PR de release solo toca changelog, manifest y versión. Se mergea con bypass de admin: `gh pr merge <n> --squash --admin --delete-branch`.
